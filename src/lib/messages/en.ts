...
export const en = {
  ...
  recipe: {
    ...
    open: "Open",
    pickBot: "Pick a Bot",
    shellNote: "This layout holds one screen. The panes scroll, the page does not.",
    onThisPage: "On this page",
    tabsAria: "Recipe sections",
    sideAria: "Install",
    sideHint: "Nothing is saved here. Copy and paste is how it installs.",
    ...
    customizeClosed: "Customize is closed. Open it to edit the recipe.",
  },
  bot: {
    allBots: "All bots",
    one: "1 Bot",
