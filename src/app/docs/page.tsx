  ...
  return (
    <div className="relative flex min-h-dvh flex-col px-6 sm:px-10 lg:px-16" style={{ background: ledger.paper, color: ledger.ink }}>
      ...
      <main className="relative z-10 mx-auto w-full max-w-2xl flex-1 pb-16 pt-10">
        ...
        <h1 className="mt-4 text-[clamp(2rem,4vw,3.2rem)] font-light leading-[1.05]" style={{ fontFamily: ledger.serif }}>Pack format and install notes</h1>
        <p className="mt-4 text-[0.78rem] uppercase tracking-[0.16em]" style={{ color: ledger.label }}>Verified on <time dateTime={site.verifiedOn}>{site.verifiedOn}</time></p>
        <div className="mt-8 space-y-6 text-[0.95rem] leading-relaxed" style={{ color: ledger.inkSoft }}>
