...
export const metadata: Metadata = {
  ...
  // Icons come from the app-directory file conventions: icon.svg (family
  // B letter mark) and apple-icon.tsx. public/favicon.svg is the same
  // mark for direct /favicon.svg and /favicon.ico requests.
  verification: {
