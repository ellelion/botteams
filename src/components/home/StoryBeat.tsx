...
export function StoryBeat({
  ...
  return (
    <section className={`story-beat relative flex min-h-0 flex-col items-center justify-center overflow-x-hidden py-3 pb-3 text-center lg:min-h-[var(--menu-max-h)] lg:py-10 lg:pb-20${active ? " is-catalog-active" : ""}`}>
      {children}
    </section>
  );
}
