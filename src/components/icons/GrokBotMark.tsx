/*
 * The Bot face on this shelf. Geometry matches x.ai/bot's static mark.
 * Colour is --fg (site accent) / --bg. Motion is CSS.
...
export function GrokBotMark({
  ...
  return (
    <svg
      className={`grok-bot-mark${animate ? " grok-bot-mark--live" : ""}${frontFacing ? " grok-bot-mark--front" : ""} ${className}`}
