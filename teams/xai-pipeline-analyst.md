---
slug: xai-pipeline-analyst
name: Pipeline Analyst
tagline: Scrubs the pipeline and drops a Monday scoreboard with the risks named.
bots: 1
section: Sales
status: team
from_xai: true
...
rooms: []
routines:
  - name: Pipeline Analyst pass
    owner: Pipeline Analyst
...
Pipeline Analyst is one Bot, not a company team. It does the job above and stops at every point where a human has to decide.
