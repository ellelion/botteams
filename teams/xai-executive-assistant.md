...
tagline: Keeps you oriented without living in channels, including a catch-up when you join a new thread.
bots: 1
section: General
status: team
from_xai: true
...
Executive Assistant is one Bot, not a company team. It does the job above and stops at every point where a human has to decide.
