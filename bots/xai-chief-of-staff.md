...
name: Chief of Staff
tagline: Reads the week across mail, calendar and chat and tells you what moved, what matters, and what to do about it.
bots: 1
section: General
status: installable
kind: bot
...
url: https://docs.x.ai/grok-bot/use-cases#chief-of-staff
connectors:
  - Gmail
  - Calendar
  - Slack
...
suggest:
  - text: Never send mail. Draft only.
    on: true
  - text: Never accept or decline a meeting for me.
    on: true
  - text: Review only until I approve. Do not send, do not change a record, do not touch production.
    on: true
---

Chief of Staff is one Bot, not a company team. It does the job above and stops at every point where a human has to decide.
